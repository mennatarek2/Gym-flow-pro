...
(function (global) {
  ...
  function apiBases() {
    ...
    if (list.indexOf('https://localhost:5001/api') < 0) list.push('https://localhost:5001/api');
    return list;
  }
  ...
  function ensureRuntimeCss() {
    ...
    style.textContent =
      ...
      '--l100:color-mix(in srgb,var(--gfp-brand-primary,#7ACC00) 16%,#fff);' +
      '}' +
      ...
      '.av-sm{background:color-mix(in srgb,var(--gfp-brand-primary,#7ACC00) 35%,#fff)!important}' +
